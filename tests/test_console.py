...
"""a module to define unittests for console.py.
Unittest classes:
...
class TestHBNBCommandPrompt(unittest.TestCase):
    """
    a module for Unittests test prompting of HBNB cmd interpreter.
    """
...
class TestHBNBCommandCount(unittest.TestCase):
    """count method of HBNB cmd interpreter."""

    @classmethod
    def setUp(self):
        try:
            os.rename("file.json", "elm")
        except IOError:
            pass
...
class TestHBNBCommandHelp(unittest.TestCase):
    """test help messages of the HBNB cmd interpreter."""
    ...
    def test_help_EOF(self):
        """test for EOF"""
        hp = "Exits from the program"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(hp, output.getvalue().strip())

    def test_help_show(self):
        hp = "Usage: show <class_name> <id> or <class>.show(<id>)"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_destroy(self):
        hp = (
            ...
            "Delete a class instance given id"
        )
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        hp = "Usage: all or all <class> or <class>.all()"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommandExit(unittest.TestCase):
    """test exiting from the HBNB cmd interpreter."""
...
class TestHBNBCommandCreate(unittest.TestCase):
    """test create from the HBNB cmd interpreter."""
...
class TestHBNBCommandShow(unittest.TestCase):
    """Utest show from the HBNB cmd interpreter"""
    ...
    def test_show_objects_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(test_d)]
            command = "show BaseModel {}".format(test_d)
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["User.{}".format(test_d)]
            command = "show User {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["State.{}".format(test_d)]
            command = "show State {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(test_d)]
            command = "show Place {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["City.{}".format(test_d)]
            command = "show City {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Amenity.{}".format(test_d)]
            command = "show Amenity {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
            test_d = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(test_d)]
            command = "show Review {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(obj.__str__(), output.getvalue().strip())


class TestHBNBCommandDestroy(unittest.TestCase):
    """test destroy from the HBNB cmdd interpreter."""
    ...
    def test_destroy_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(test_d)]
            command = "destroy BaseModel {}".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
    ...
    def test_destroy_objects_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(test_d)]
            command = "BaseModel.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["User.{}".format(test_d)]
            command = "User.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["State.{}".format(test_d)]
            command = "State.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(test_d)]
            command = "Place.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["City.{}".format(test_d)]
            command = "City.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Amenity.{}".format(test_d)]
            command = "Amenity.destroy({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(test_d)]
            command = "Review.destory({})".format(test_d)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(obj, storage.all())


class TestHBNBCommandAll(unittest.TestCase):
    """test all of the HBNB cmdd interpreter."""
    ...
    def test_all_invalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("all Good"))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("all Chair"))
            self.assertEqual(correct, output.getvalue().strip())
...
class TestHBNBCommandUpdate(unittest.TestCase):
    """update from the HBNB cmd interpreter."""
